...
<div class="px-4 sm:px-0">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            Welcome back, {{ Auth::user()->name }}. Here's what's happening with your application.
        </p>
    </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $stats['regular_users'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">New Users (30d)</dt>
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $stats['recent_users'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('admin.users') }}" class="text-sm font-medium text-red-600 hover:text-red-500">
                    View all users →
                </a>
            </div>
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('admin.users.show', $user) }}" class="text-red-600 hover:text-red-900">View</a>
                            </td>
                        </tr>
                        @empty
                        <tr>
    ...
    <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            ...
            <div class="space-y-3">
                <a href="{{ route('admin.users') }}" class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-md hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                    <svg class="w-5 h-5 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"></path>
                    </svg>
                    <span class="text-sm font-medium text-gray-900 dark:text-white">Manage All Users</span>
                </a>
            </div>
        </div>
